...
**Actual command:**
```bash
mysql -h a3-g7-rds.c1234567890.us-east-1.rds.amazonaws.com -u admin -p countries < /home/ec2-user/database.sql
```
...
|---|---|---|
| Value | PLACEHOLDER | `a3-g7-rds.c1234567890.us-east-1.rds.amazonaws.com` |

Replace with your actual RDS endpoint (the one you copied in Task 2).
